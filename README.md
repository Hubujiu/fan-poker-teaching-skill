...
[🌐 在线演示](https://hubujiu.github.io/fan-poker-teaching-skill/) · [安装 Skill](#-安装) · [快速体验](#-快速体验) · [English](./README_EN.md)
...
最方便的方式是打开 [GitHub Pages 在线演示](https://hubujiu.github.io/fan-poker-teaching-skill/)。仓库中也提供以下入口：

| 示例 | 适合查看 |
|---|---|
| [`index.html`](./index.html) | 项目落地页与在线牌组 |
| [`examples/docker-lesson.html`](./examples/docker-lesson.html) | AI 生成真实教学内容的效果 |
| [`examples/animation-features-demo.html`](./examples/animation-features-demo.html) | 动画能力与交互方式 |
...
也可以下载仓库 ZIP，然后把整个目录放入 Skills 目录。不同客户端的目录位置不同，请以对应客户端文档为准。
